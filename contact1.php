...
include('/home/siddhesh/public_html/Websites/worldempower.in/testing/phpmailer/class.phpmailer.php');
    ...
    $clientmailcontent="
			...
			<tr>
				<td height='68' width='250' ><img src=http://sparkleindustries.co.in/testing/assets/img/logo.png></td>
			</tr>
			<tr>
			...
			<tr>
				<td height='122' width='250'>
					<br>
                     <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sparkle Industries</strong><br>
					 <span class='contact-icon'><i class='fa fa-map-marker' style='font-size:24px;color:red'></i></span>&nbsp;&nbsp;   Registered Office :- At Post Ashtapur,<br> Near Jay Baba Temple<br>
				  Ramkrishna Karayalay,<br>Ashtapur Gaon Road<br>
				  Maharashtra,India <br><br>
					 <span class='contact-icon'><i class='fa fa-phone' style='font-size:24px;color:red'></i></span>&nbsp; (+91) 7709998079<br><br>
					 <span class='contact-icon'><i class='fa fa-envelope' style='font-size:24px;color:red'></i></span>&nbsp; info@sparkleindustries.co.in
					 </address>
				</td>
			</tr>
		</table>";
	        ...
	        $email = new PHPMailer();
	        $email->From      = 'info@sparkleindustries.co.in';
	        $email->FromName  = 'Sparkle Industries';
	        $email->Subject   = "Sparkle Industries";
		    ...
		    <tr>
				<td height='52' width='250'>Regards<br>Sparkle Industries</td>
			</tr>
    		</table>";
	        ...
	        $email->IsHTML(true); 
	        $email->AddAddress( 'info@sparkleindustries.co.in' );   
	        $b=$email->Send();
